...
// Author: Steven Becerra (steveb@digipet.com) ///////////////////////////////////////////
...
contract Digipet is AccessControl, DetailedERC721 {
    ...
    function getGen0Amount() public view returns (uint256 _generation0Amount) {
        return generation0Amount;
    }

    function getPetID(uint128 _dnaPet) public view returns (uint256 _petID) {
        return dnaToPetID[_dnaPet];
    }

    function getDescendants(uint256 _petID) public view returns (uint256 _descendants) {
    ...
    function priceOf(uint256 _petID) public view returns (uint256 _price) {
    ...
    function getStartingPrice() public view returns (uint256 _price) {
    ...
    function totalSupply() public view returns (uint256 _totalSupply) {
        _totalSupply = pets.length;
    }

    function balanceOf(address _owner) public view returns (uint256 _balance) {
        _balance = ownershipPetCount[_owner];
    }

    function ownerOf(uint256 _petID) public view returns (address _owner) {
        _owner = petIDToOwner[_petID];
    }
